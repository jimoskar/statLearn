...
# Problem 1
## a)
FALSE \textcolor{red}{Side 204 eks, tenker TRUE} \textcolor{green}{Jeg tolker denne påstanden som at regularisering alltid reduserer test-error, og det er ikke sant, ellers hadde vi alltid brukt det.}, TRUE, TRUE, FALSE
...
TRUE, TRUE, FALSE \textcolor{red}{litt usikker her, spurte på piazza.}, FALSE 
...
(\textbf{Why?}) This is the best way to prune the tree down to three leaves because we assume that the length of the branches is proportional to the decrease in node impurity. \textcolor{red}{Jeg tok bort det med stratidication, tror ikke jeg skjønte det...noe mer som bør nevnes her?}
...
c1 <- calc_centr(1, df)
c2 <- calc_centr(2, df)
plot(df$x1, df$x2, col = df$cluster, pch = 19, xlab = "x1", ylab = "y1")
...
plot(df2$x1, df2$x2, col = df2$cluster, pch = 19, xlab = "x1", ylab = "y1")
```
