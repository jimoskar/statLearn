...
TRUE, TRUE, FALSE (usikker, \textcolor{green}{logreg bryter jo sammen når p >n, men det finnes vel ridge-metoder for logreg som gjør at det funker?} \textcolor{red}{Siden logreg bryter sammen så regner jeg med at svaret er FALSE. Tror ikke de regner med andre metoder for optimering, da vi egt ikke har gjennomgått dette.}), TRUE
