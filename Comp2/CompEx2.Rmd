...
\textcolor{green}{grunnen til at dn er kvadrert er vel for at størrelsen ikke skal bli negativ? Men sikkert greit å spørre!}
## b) 
...
# Usikker på hvorfor shape endres til firkant i legend her, men jeg skjønner ikke ggplot helt så hva vet vel jeg. # Jim: Gjorde sirklene litt større så ordna det seg ;)
```
