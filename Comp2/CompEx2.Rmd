...
best.tree <- prune.misclass(simple.tree, best = cv.diabetes$size[best]) # Du ser at til tross for at best = 3, så får man treet med 6 uansett.
# Det tror jeg er fordi vi bruker prune.misclass her uansett, selv om FUN = prune.misclass ikke brukes ovenfor!
plot(best.tree)
