...
```
From the last ANOVA table, we see that the p-value is somewhat low ($p \approx 0.056$), which coulc be considered evidence that survival probabilities differed between hatch islands, but more data should be gathered to test that it is not low by chance.
