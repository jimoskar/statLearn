...
(ii) We would choose the tuning parameter $k$ based on a $K$-fold cross validation, with $K = 5$ or $K = 10$. \textcolor{green}{virket som om dette var nok!} (elaborate, saw it in the lecture on linear regression, but not quite sure how it is done in practice).

(iii) The KNN classification fit can be seen below

```{r}
set.seed(123) # For reproducibility. USIKKER PÅ OM DENNE BURDE VÆRE MED!!?!??
