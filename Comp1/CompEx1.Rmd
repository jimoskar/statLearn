...
## b) 
Since we want to understand the probability of decease of covid-19, we fit a logistic regression model as opposed a linear regression model.
...
The standard error is `r round(sd(r.squared)/summary(lm.fit5)$r.squared*100, digits = 3)` % of $R^2$. Also, $R^2$ is contained in the confidence interval. This suggests that the bootstrap can be used to estimate the uncertainty of $R^2$. \textcolor{red}{Hva mer skal vi skrive i tolkningen? Også: Ikke 12 sider!}
