...
(ii) I would probably use cross validation to test the predictive power for different $K$ (elaborate, saw it in the lecture on linear regression, but not quite sure how it is done in practice). \textcolor{red}{Spørre om dette kanskje?! Jeg er veldig usikker på dette. }
